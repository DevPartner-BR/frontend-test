    ...
    var Core = function (options) {
        ...
        var runSideMenu = function (options) {
            ...
            var collapseMenu = function () {
                $('#toggle_sidemenu_l').addClass('rot180-right');
                $('#sysLogo').hide();
                $('#sysMenu').addClass('sysMenuContract');
                $('.icoMenu').addClass('icoMenuContract');
            }

            var expandMenu = function () {
                $('#toggle_sidemenu_l').removeClass('rot180-right');
                $('#sysLogo').show();
                $('#sysMenu').removeClass('sysMenuContract');
                $('.icoMenu').removeClass('icoMenuContract');
            }
            ...
            var sbOnLoadCheck = function () {
                ...
                // If window is < 1140px wide collapse both sidebars and add ".mobile-view" class
            ...
            var sbOnResize = function () {
                ...
                // If window is < 1140px wide collapse both sidebars and add ".mobile-view" class
                if ($(window).width() < 1140 && !Body.hasClass('mobile-view')) {
                    collapseMenu();
                    Body.removeClass('sb-r-o').addClass('mobile-view sb-l-m sb-r-c');
            ...
            $('.sidebar-menu li a.accordion-toggle').on('click', function (e) {
                ...
                //e.preventDefault(); ################  CONFLITO COM UI-ROUTER ##############################
...
//custom code
    ...
    //muda icone de collapse na barra dos paineis
    $('div').click(function (e) {
        var kids = $(e.target).children();

        if (kids.length == 2) {
            var objTarget = $(e.target).children('.panel-closeIco');

            if (objTarget.hasClass('rot90-left')) {
                objTarget.removeClass('rot90-left');
            } else {
                objTarget.addClass('rot90-left');
            }
        }
        ...
        if (kids.length == 0) {
            if ($(e.target).hasClass('fa')) {
                var objTarget = $(e.target).parent('.panel-closeIco');
                ...
                var objTarget = $(e.target).parent().parent().children('.panel-closeIco');
